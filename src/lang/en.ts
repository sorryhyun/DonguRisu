export const languageEnglish = {
    ...
    pluginV2Warning: "**DEPRECATION NOTICE:** Plugin V2 and V2.1 are deprecated and will be removed in a future release.\n\n**Timeline:**\n- Immediate: Consider migrating to V3.0\n- 6 months: V2/V2.1 plugins will show prominent warnings\n- 12 months: V2/V2.1 support will be removed\n\nV2.1 plugins lack the security isolation of V3.0 and pose potential security risks.\n\n**For plugin developers:** Please migrate to the V3.0 API using the migration guide at plugins/migrationGuide.md. V3.0 provides better security through iframe sandboxing and improved APIs.",
