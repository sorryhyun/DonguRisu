export const languageKorean = {
    ...
    "pluginV2Warning": "**지원 중단 안내:** 플러그인 V2 및 V2.1은 지원이 중단되었으며 향후 릴리스에서 제거될 예정입니다.\n\n**일정:**\n- 즉시: V3.0으로 마이그레이션을 고려하세요\n- 2026년 3분기: V2.0 지원 제거\n- 2026년 4분기: V2.1 지원 제거\n\nV2.1 플러그인은 V3.0의 보안 격리 기능이 부족하여 잠재적인 보안 위험이 있습니다.\n\n**플러그인 개발자를 위한 안내:** plugins/migrationGuide.md의 마이그레이션 가이드를 참조하여 V3.0 API로 마이그레이션하세요. V3.0은 iframe 샌드박싱과 개선된 API를 통해 더 나은 보안을 제공합니다."
};
